...
bindsym XF86AudioRaiseVolume exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SINK@ 10%+ -l 1 && $refresh_i3status
...
# bindsym Shift+$mod+l exec i3lock -c 000000 && systemctl suspend
...
client.focused          $darkgray $darkgray $lightgray $purple $darkgray
client.focused_inactive $gray $gray $bg $purple $darkgray
client.unfocused        $gray $gray $bg $purple $darkgray
